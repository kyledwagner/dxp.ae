(function (global, factory) {
  ...
  var defaults = {
    ...
    svg: {
      ...
      next: '<svg xmlns="http://www.w3.org/2000/svg" width="45" height="9" viewBox="0 0 45 9"><polygon fill="#FFF" points="227.412 1.774 228.678 .226 238.412 8.182 194 8.182 194 6.182 232.804 6.181" transform="translate(-194)"/></svg>',
      prev: '../assets/icon/prev.svg'
    }
  };
